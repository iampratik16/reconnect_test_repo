...
const STEPS = [
  {
    ...
    body: "Comprehensive biomechanical and lifestyle evaluation — your diagnosis, imaging, pain map, and history all shape the prescription. Nothing is assumed.",
  ...
  },
  {
    ...
    body: "Movement calibrated to your specific joints, muscle groups, and functional goals. Designed by Dr. Shruthi — not a generic plan, a precise prescription.",
